...
class  User extends MachineOptions{
    ...
    logic(){
        if(this._selected === this._sort){
            return `${this._name}, A máquina escolheu: ${this._sort}. Você escolheu: ${this._selected} - Você empatou!!!`
            ...
            return `${this._name}, A máquina escolheu: ${this._sort}. Você escolheu: ${this._selected} - Você ganhou!!`
        } else {
            return `${this._name}, A máquina escolheu: ${this._sort}. Você escolheu: ${this._selected} - Você perdeu!!!`
        }
    }
